use {fehler::throws, vector::xy, crate::{music_xml::Harmony, measure::MeasureLayoutContext, staff::Staff}};
impl MeasureLayoutContext<'_,'_> {
	#[throws(as Option)] pub fn harmony(&mut self, _: &mut [Staff], harmony/*Harmony{step, alter}*/: &Harmony) {
